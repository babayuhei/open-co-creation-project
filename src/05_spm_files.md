...
| ファイル | 内容 |
|:--------|:-----|
| [storyline.md](starter/01_settings/storyline.md) | 作品コンセプト・核心メッセージ・全体構成・各部テーマ |
| [os_theory.md](starter/01_settings/os_theory.md) | OS理論の体系（自分本位↔他者本位、思考型↔行動型の4象限）|
| [characters.md](starter/01_settings/characters.md) | 登場人物のOS・形成背景・変容プロセス・口調設計 |
| [style_guide.md](starter/01_settings/style_guide.md) | 文体ルール・NG表現・シーンタイプ別構成パターン |
| [app_design.md](starter/01_settings/app_design.md) | PDCA・GROWモデルの埋め込み設計・[L]シーン8ステップ構造 |
...
| ファイル | 内容 |
|:--------|:-----|
| [全体構成概観](starter/02_plots/cross_part_overview.md) | 全体の時系列・伏線マップ・部ごとのテーマ |
| [第1部サマリー](starter/02_plots/scene_summaries_part1.md) | 第1部・全シーンのビート・PDCA層・伏線情報 |
| [第2部サマリー](starter/02_plots/scene_summaries_part2.md) | 第2部・全シーンのビート・PDCA層・伏線情報 |
| [第3部サマリー](starter/02_plots/scene_summaries_part3.md) | 第3部・全シーンのビート・PDCA層・伏線情報 |
...
このプリンシプルはv18時点のもので、[小説リポジトリ](https://github.com/babayuhei/confession-of-a-loser) の `v18/00_project_principles.md` で参照できます（MIT License）。
